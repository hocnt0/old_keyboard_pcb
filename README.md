...
#note
Vintage Mechanical Keyboard PCB Replica
...
Important Disclaimers
    ...
    Reverse-Engineered: This PCB was recreated entirely by taking manual measurements from an original, physical board.
...
If you find an error, missing trace, or incorrect dimension, please feel free to:
    ...
    Submit a Pull Request with the corrected KiCad files.

Any help to make this replica more accurate is greatly appreciated!
